...
def computeC(psiHatP=None, filledImage=None, confidenceImage=None):
    ...
    con_val = copyutils.getWindow(confidenceImage, (psiHatP.row(), psiHatP.col()), psiHatP.radius())[0]
    valid_val = copyutils.getWindow(confidenceImage, (psiHatP.row(), psiHatP.col()), psiHatP.radius())[1]
    #########################################
...
def computeGradient(psiHatP=None, inpaintedImage=None, filledImage=None):
    ...
    inp_img, _ = copyutils.getWindow(grey_img, (psiHatP.row(), psiHatP.col()), psiHatP.radius())
    fill_img, _ = copyutils.getWindow(filledImage, (psiHatP.row(), psiHatP.col()), psiHatP.radius())
...
def computeNormal(psiHatP=None, filledImage=None, fillFront=None):
    ...
    front_img = copyutils.getWindow(fillFront, (psiHatP.row(), psiHatP.col()), psiHatP.radius())
    fill_img = copyutils.getWindow(filledImage, (psiHatP.row(), psiHatP.col()), psiHatP.radius())[0] / 255.00
    valid_img = front_img * fill_img
    X = cv.Sobel(fill_img, cv.CV_64F, 1, 0)
    Y = cv.Sobel(fill_img, cv.CV_64F, 0, 1)

    XY = math.sqrt(X[psiHatP.radius(), psiHatP.radius()] * X[psiHatP.radius(), psiHatP.radius()] + Y[
        psiHatP.radius(), psiHatP.radius()] * Y[psiHatP.radius(), psiHatP.radius()])
